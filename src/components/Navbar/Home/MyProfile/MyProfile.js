...
const MyProfile = () => {
    ...
    return (
        <div className='container sm:conatiner'>
            <div class="card lg:w-3/4 mx-auto p-5 lg:card-side bg-base-100 shadow-xl">
                <figure ><img className='w-36' src={user?.photoURL} alt="" /></figure>
                <div class="card-body items-start">
                    <h2 class="">Name: {user?.displayName}</h2>
                    <h2 class="">Email: {user?.email}</h2>
                    <h2 class="">address: {userData.data.address}</h2>
                    <h2 class="">Phone: {userData.data.phone}</h2>
                    <h2 class="">Linkedin: {userData.data.linkedin}</h2>
                </div>
            </div>
